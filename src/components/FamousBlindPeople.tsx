...
const FamousBlindPeople: React.FC = () => {
  ...
  const getPersonImage = (personId: string) => {
    // Map person IDs to actual image files (using direct paths from public folder)
    const imageMap: Record<string, string> = {
      ...
      paul: `/images/people/paul-castle.png`,
      harriet: `/images/people/harriet-tubman.png`,
      casey: `/images/people/casey-harris.png`,
      haben: `/images/people/haben-girma.png`,
      molly: `/images/people/molly-burke.png`,
      tilly: `/images/people/tilly-aston.png`,
      sabriye: `/images/people/Sabriye-Tenberken.png`,
      anastasia: `/images/people/Anastasia-Pagonis.png`,
      mila: `/images/people/mila-kunis.webp`,
      judi: `/images/people/judi-dench.webp`,
      bono: `/images/people/bono.webp`,
      georgia: `/images/people/Georgia-OKeeffe.webp`,
      ella: `/images/people/Ella-Fitzgerald.webp`,
      sugar: `/images/people/sugar-ray-leonard.webp`,
      stephen: `/images/people/stephen-curry.webp`,
      allan: `/images/people/allan-pineda-lindo.webp`,
      fetty: `/images/people/fetty-wap.webp`,
      slick: `/images/people/slick-rick.webp`,
      abraham: `/images/people/abraham-nemeth.webp`
    };
