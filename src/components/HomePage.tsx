                  ...
                  <Box sx={{ flex: 1 }}>
                    ...
                    <Box sx={{ 
                      ...
                      <Box sx={{ 
                        ...
                        <img 
                          src="/blindness-visualizer/images/people/john-milton.jpg" 
                          alt="John Milton"
                          style={{ 
                            width: '100%', 
                            height: '100%', 
                      ...
                      <Box sx={{ 
                        ...
                        <img 
                          src="/blindness-visualizer/images/people/stevie-wonder.jpg" 
                          alt="Stevie Wonder"
                          style={{ 
                            width: '100%', 
                            height: '100%', 
                      ...
                      <Box sx={{ 
                        ...
                        <img 
                          src="/blindness-visualizer/images/people/hellen-keller.jpg" 
                          alt="Helen Keller"
                          style={{ 
                            width: '100%', 
                            height: '100%', 
                      ...
                      <Box sx={{ 
                        ...
                        <img 
                          src="/blindness-visualizer/images/people/ray-charles.jpg" 
                          alt="Ray Charles"
                          style={{ 
                            width: '100%', 
                            height: '100%', 
