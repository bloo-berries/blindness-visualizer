 ...
 */
export const ANIMATED_EFFECTS = ['visualAura', 'visualAuraLeft', 'visualAuraRight', 'hallucinations', 'blueFieldPhenomena', 'persistentPositiveVisualPhenomenon', 'palinopsia', 'starbursting', 'christineFluctuatingVision', 'sugarRetinalDetachmentComplete', 'sugarPeripheralFlashes'];
...
/**
 * Hook that generates animated overlay styles for visual aura, hallucinations, blue field, PPVP, palinopsia, starbursting, Christine Ha, and Sugar Ray Leonard effects
 */
