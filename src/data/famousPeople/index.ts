...
export const categories: PersonCategory[] = [
  ...
  { id: "athletes", name: "Athletes", people: ["erik", "marla", "anastasia", "sugar", "stephen", "lex", "davidBrown", "anthonyClarke", "crazzySteve", "tofiri", "ross", "trischa", "henry", "zeeshanAbbasi", "terezinhaGuilhermina", "silvaniaCosta", "luciaTeixeira"] },
  { id: "scientists", name: "Scientists & Medical Professionals", people: ["mona", "joshua", "geerat", "amyBower", "gustafDalen", "jacobBolotin", "josephPlateau", "euler", "wanda", "abraham", "olgaHahnNeurath"] },
  { id: "musicians", name: "Musicians", people: ["ray", "stevie", "bocelli", "casey", "bono", "ella", "allan", "fetty", "slick", "jose", "art", "ronnie", "doc", "jeff", "diane", "nobuyuki", "rahsaan", "blindLemonJefferson", "charlottaSeuerling", "francescoLandini", "garretBarry", "gurrumulYunupingu", "geraldineLawhorn", "heatherHutchison", "joaquinRodrigo", "rachael", "johnKay", "jonnyGreenwood", "amadou", "nanaMouskouri", "moondog", "ravindraJain", "kimioEto", "dianaGurtskaya", "asikVeysel", "joseCid", "bluay", "anselmoRalph", "mariaAnnaMozart"] },
