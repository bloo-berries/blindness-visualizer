...
export const categories: PersonCategory[] = [
  ...
  { id: "writersActivists", name: "Writers, Activists, Politicians", people: ["helen", "ved", "tilly", "sabriye", "borges", "thurber", "levPontryagin", "garyODonoghue", "paterson", "blunkett", "floydMorris", "henryFawcett", "jacquesLusseyran", "tiffany", "jamesJoyce", "aldousHuxley", "jeanPaulSartre", "tahaHussein", "chenGuangcheng", "kerryannIfill", "rhinaAguirre", "mariaJosefaMujia"] },
