...
export const PEOPLE_IMAGE_MAP: Record<string, string> = {
  ...
  olgaHahnNeurath: 'olga-hahn-neurath.webp',
  ...
  aarneArvonen: 'Aarne-Arvonen.webp',
  jussiKekkonen: 'Jussi-Kekkonen.webp',
  frankLaRue: 'Frank-La-Rue.webp',
  beloCipriani: 'belo-cipriani.webp',
  ingaSaeland: 'Inga-Sæland.webp',
  lahjaIshitile: 'Lahja-Ishitile.webp',
  amenehBahrami: 'Ameneh-Bahrami.webp',
  roniOhayon: 'Roni-Ohayon.webp',
  johnAsfour: 'John-Asfour.webp',
  wessehFreeman: 'Wesseh-Freeman.webp',
  alanNamoko: 'Alan-Namoko.webp',
  taonereBanda: 'Taonere-Banda.webp',
  jockOrr: 'jock-orr.webp',
  eddieLow: 'Eddie-Low.webp',
  nojimMaiyegun: 'Nojim-Maiyegun.webp',
  oscarPlatou: 'Oscar-Ludvig-Stoud-Platou.webp',
  syedPirzada: 'Syed-Sardar-Ahmed-Pirzada.webp',
  anaLucreciaTaglioretti: 'Ana-Lucrecia-Taglioretti.webp',
  mariaReiche: 'Maria-Reiche.webp',
  melanieLipinska: 'Mélanie-Lipinska.webp',
  costacheAristia: 'Costache-Aristia.webp',
  borisDyozhkin: 'Boris-Dyozhkin.webp',
  vasilyEroshenko: 'Vasily-Eroshenko.webp',
  mikhalinaLysova: 'Mikhalina-Lysova.webp',
  kelvinTan: 'kelvin-tan.webp',
